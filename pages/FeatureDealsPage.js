...
export class FeatureDealsPage {
    ...
    constructor(page) {
        ...
        this.uploadImage=page.locator("#deal-image-file")
        ...
        this.hotel_name=" "
        //div[@class='grid grid-cols-1 md:grid-cols-3 gap-6']/div//h3[contains(text(),'${hotelname}')]
            //div[@class='grid grid-cols-1 md:grid-cols-3 gap-6']/div//h3[contains(text(),'almara Maldives Resort')]
    }
    async addFeatureDeals(){
        console.log("I am in add featire deal function")
        await this.addDealBtn.click();
        await this.uploadImage.setInputFiles("/Users/sandhyagadhasu/Documents/Holidayposters/Coral Los Alisios.png")
        await this.hotelName.fill("Marmaris alma Resort")
